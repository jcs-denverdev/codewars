...
function declareWinner(fighter1, fighter2, firstAttacker) {
    ...
    //     console.log(`${firstAttacker} attacks ${fighter2.name}; ${fighter2.name} now has ${fighter2.health} health and is dead. ${fighter1.name} wins.`)
    ...
    //     console.log(`${firstAttacker} attacks ${fighter1.name}; ${fighter1.name} now has ${fighter1.health} health and is dead. ${fighter2.name} wins.`)
